...
void draw_Arrow(){
	ssd1306_Line(4, 54, 4, 61, Black);
		ssd1306_DrawPixel(3,55 , Black);
		ssd1306_DrawPixel(5,55 , Black);
		ssd1306_DrawPixel(2,56 , Black);
		ssd1306_DrawPixel(6,56 , Black);
		ssd1306_Line(8, 54, 8, 61, Black);
		ssd1306_DrawPixel(7,60 , Black);
		ssd1306_DrawPixel(9,60 , Black);
		ssd1306_DrawPixel(6,59 , Black);
		ssd1306_DrawPixel(10,59 , Black);
}
